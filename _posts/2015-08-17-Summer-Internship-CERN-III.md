...
A rolling forecast is performed which helps us to predict binary popularity values for each week.
...
using the MLlib which has defined Random Forest, Naive Bayes and Stochastic Gradient
Descent.
...
polynomial such as a linear function.
